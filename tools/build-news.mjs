...
import { esc, figureHtml, mdToHtml } from "./md.mjs";
...
// =========================================================================
// frontmatter (the markdown subset lives in md.mjs)
// =========================================================================
...
fs.writeFileSync(path.join(ROOT, "news-latest.html"), posts.slice(0, 5).map(postRowHtml).join("\n") + "\n");
