#!/usr/bin/env bash
#
# Sign + notarize + staple a Slice plug-in bundle (AU or VST3) for
...
#      timestamp, and the dist/Slice.entitlements file (which
...
ENTITLEMENTS="$SCRIPT_DIR/Slice.entitlements"
...
NOTARY_LOG="$(mktemp -t slice-notary)"
