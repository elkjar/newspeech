#!/usr/bin/env bash
#
# Sign + notarize + staple a Saturate plug-in bundle (AU or VST3) for
...
#      timestamp, and the dist/Saturate.entitlements file (which
...
ENTITLEMENTS="$SCRIPT_DIR/Saturate.entitlements"
...
NOTARY_LOG="$(mktemp -t saturate-notary)"
