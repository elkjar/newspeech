#!/usr/bin/env bash
#
# Sign + notarize + staple a Glitch plug-in bundle (AU or VST3) for
...
#      timestamp, and the dist/Glitch.entitlements file (which
...
ENTITLEMENTS="$SCRIPT_DIR/Glitch.entitlements"
