#!/usr/bin/env bash
#
# Sign + notarize + staple an AU .component for distribution.
#
# Usage:
#   ./sign-and-notarize.sh <path-to-component>
#
...
#      timestamp, and the dist/GlitchFX.entitlements file (which
...
ENTITLEMENTS="$SCRIPT_DIR/GlitchFX.entitlements"
...
ZIP="$BUNDLE_DIR/${BUNDLE_NAME%.component}.zip"
rm -f "$ZIP"
