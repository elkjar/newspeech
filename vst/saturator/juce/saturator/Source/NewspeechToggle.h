...
// match the knob ring. Handles both AudioParameterBool and AudioParameterFloat
// with step=1, range 0..1 — both implement RangedAudioParameter and use
// 0.0/1.0 normalised values, so one wrapper covers both.
