...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      audio::audio_start_recording_stems,
      audio::audio_stop_recording_stems,
      audio::audio_is_recording_stems,
      audio::audio_stop_all,
      audio::audio_panic,
      audio::audio_flush_pending,
      audio::audio_device_default_config,
      audio::audio_loop_capture,
      audio::audio_loop_stop,
      audio::audio_loop_bounce,
      audio::audio_noise_capture,
